<?php
/* Smarty version 3.1.34-dev-7, created on 2020-02-29 17:13:28
  from 'C:\wamp64\www\Ecomie\application\views\templates\pages\mentions.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5e5a9bb807c5c2_31524395',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '30d30fc79a9fbb6e69491a47791e6d2e6a76d0df' => 
    array (
      0 => 'C:\\wamp64\\www\\Ecomie\\application\\views\\templates\\pages\\mentions.tpl',
      1 => 1582996376,
      2 => 'file',
    ),
  ),
...
function content_5e5a9bb807c5c2_31524395 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_subTemplateRender("file:header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('title'=>"Ecomie - Conditions générales d'utilisation",'name'=>$_smarty_tpl->tpl_vars['Name']->value), 0, false);
?>
<div class="CGU">
    <section>
        <h2>Conditions générales d'utilisation</h2>
        <p>En vigeur au 05/02/2020</p>
    </section>
    <section>
        <p>Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement
            juridique des modalités de mise à
            disposition du site et des services par et de définir les conditions d’accès et d’utilisation des
            ...
            CGU en cochant la case précédant le texte suivant : « Je reconnais avoir lu et compris les CGU et je
            les accepte ».
            En cas de non-acceptation des CGU stipulées dans le présent contrat, l'Utilisateur se doit de
            renoncer à l'accès des services
            proposés par le site.
            ecomie.fr se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes
            CGU
        </p>
    </section>
    <section>
        <h3>Article 1 : Les mention légales</h3>
        <p>L’édition et la direction de la publication du site ecomie.fr est assurée par abeilhe, domicilié 44
            rue saint urbain.
            Numéro de téléphone est 0688708192
            Adresse e-mail abeilhejeanbaptiste@yahoo.fr.
            L'hébergeur du site ecomie.fr est la société Ecomie&co, dont le siège social est situé au CCI
            colmar, avec le numéro de
            téléphone : 0688708193.
        </p>
    </section>
    <section>
        <h3>Article 2 : Accés au site</h3>
        <p>Le site ecomie.fr permet à l'Utilisateur un accès gratuit aux services suivants :
            ...
            l'Utilisateur pour accéder au service (matériel informatique, logiciels, connexion Internet, etc.)
            sont à sa charge.
            ...
            son mot de passe qui lui seront
    ...
    <section>
        ...
        <p>Les marques, logos, signes ainsi que tous les contenus du site (textes, images, son…) font l'objet
            d'une protection par le Code de
            ...
            s'engage à une utilisation des contenus du site dans un cadre strictement privé, toute utilisation à
            ...
            site Internet constituerait une contrefaçon sanctionnée par l’article L 335-2 et suivants du Code de
            la propriété intellectuelle.
            Il est rappelé conformément à l’article L122-5 du Code de propriété intellectuelle que l’Utilisateur
            qui reproduit, copie ou publie le
            contenu protégé doit citer l’auteur et sa source.
        </p>
    </section>
    <section>
        <h3>Article 5 : Responsabilité</h3>
        <p>Les sources des informations diffusées sur le site ecomie.fr sont réputées fiables mais le site ne
            ...
            régulières, le site ecomie.fr ne peut être tenu responsable de la modification des dispositions
            administratives et juridiques
            survenant après la publication. De même, le site ne peut être tenue responsable de l’utilisation et
            ...
            Le site ecomie.fr ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter
            l’ordinateur ou tout matériel
            informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant de
            ce site.
    ...
    <section>
        <h3>Articles 6 : Liens hypertextes</h3>
        <p>Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur
            ...
            ecomie.fr. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles aboutissent ces liens et
    ...
    <section>
        ...
        <p>L’Utilisateur est informé que lors de ses visites sur le site, un cookie peut s’installer
            ...
            qui sont nécessaires à l’utilisation du site ecomie.fr. Les cookies ne contiennent pas d’information
            personnelle et ne peuvent pas
            être utilisés pour identifier quelqu’un. Un cookie contient un identifiant unique, généré
            aléatoirement et donc anonyme. Certains
            cookies expirent à la fin de la visite de l’Utilisateur, d’autres restent.
            L’information contenue dans les cookies est utilisée pour améliorer le site ecomie.fr.
            En naviguant sur le site, L’Utilisateur les accepte.
            L’Utilisateur doit toutefois donner son consentement quant à l’utilisation de certains cookies.
            A défaut d’acceptation, l’Utilisateur est informé que certaines fonctionnalités ou pages risquent de
            lui être refusées.
            L’Utilisateur pourra désactiver ces cookies par l’intermédiaire des paramètres figurant au sein de
    ...
    <section>
        ...
        <p>Le site permet aux membres de publier les contenus suivants :
            ...
            publication, directement ou par un tiers autorisé, dans le monde entier, sur tout support (numérique
            ou physique), pour la durée
            de la propriété intellectuelle. Le Membre cède notamment le droit d'utiliser sa publication sur
            internet et sur les réseaux de
            téléphonie mobile.
            La société éditrice s'engage à faire figurer le nom du membre à proximité de chaque utilisation de
            sa publication.
            Tout contenu mis en ligne par l'Utilisateur est de sa seule responsabilité. L'Utilisateur s'engage à
            ne pas mettre en ligne de
            contenus pouvant porter atteinte aux intérêts de tierces personnes. Tout recours en justice engagé
            par un tiers lésé contre le site
